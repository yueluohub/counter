...
if {[regexp {2002|2001|2003\.06|2003\.03} $sh_product_version] == 1} { ;# version prior to 2003.12
    ...
    # ============================================================== #
    #    Add NDS naming rules to the design analyzer scripts menu    #
    # ============================================================== #
    
    set view_script_submenu_items \
    [list {Apply NDS CORE name rule} {change_names -rules nds_core_rule -hierarchy} \
    {Apply NDS TOP name rule} {change_names -rules nds_top_rule}]
